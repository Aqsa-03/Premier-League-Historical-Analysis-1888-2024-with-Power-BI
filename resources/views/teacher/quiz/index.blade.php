...
@section('content')
    <div class="container mt-5">
        <h1><u>Add Quiz</u></h1>
        <form class="php-email-form" id="gradeForm" action="{{ route('teacher.quizzes.store') }}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Title</label>
                <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Quiz # 3">
