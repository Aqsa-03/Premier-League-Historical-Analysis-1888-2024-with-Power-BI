...
@section('content')
    <div class="container mt-5">
        <h1><u>Add Assignment</u></h1>
        <form class="php-email-form" id="gradeForm" action="{{ route('teacher.assignments.store') }}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Title</label>
                <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Assignment # 3">
                <div id="title-error" class="error"></div>
            </div>

            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3" placeholder="Add description or instructions about assignment"></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" name="due_date_time" class="form-control" id="exampleFormControlInput1">
                <div id="due_date_time-error" class="error"></div>
            </div>
            
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Upload File (Optional)</label>
